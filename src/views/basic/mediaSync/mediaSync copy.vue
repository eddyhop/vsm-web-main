    ...
    <div class="top">
      <div class="search">
        <h3>
          ...
          <span>{{$t('DeviceMan.DeviceSynchronization')}}</span>
        </h3>
      </div>
      <dl class="devSelect">
        <dt>
          ...
          <div :class="`formItem ${lang=='en' ? 'formItemEn' : ''}`">
            ...
            >
              ...
              <el-option value="NaaS" label="NaaS"></el-option>
              <el-option value="Transit Gateway" label="Transit Gateway"></el-option>
              <el-option value="Acceleration Gateway" label="Acceleration Gateway"></el-option>
              <el-option value="Tradition" label="Tradition"></el-option>
            </el-select>
          </div>
      ...
      >
        ...
        >
          <template slot-scope="scope">
            ...
            >{{$t("DeviceMan.DistributionOfTheTenant")}}</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div class="page">
...
export default {
  ...
  methods: {
    ...
    vsrTb() {
      ...
      // VSR synchronous vsa
      //VSR synchronous vsa
      var show6 = localStorage.getItem("show6");
      if(show6 == 'true') {
        syncVsa().then(res => {
            if (res.code == 10000) {
              this.$message({
        ...
        this.$confirm(this.$t("DeviceMan.hint10")+"<div style='left:10px;position:absolute;top:45px'><label><input onClick='localStorage.setItem(\"checkedValue6\",this.checked)' type='checkbox'> "+this.$t("doNotShowThisAgain")+"</label></div>", {
        ...
        .then(() => {
          syncVsa().then(res => {
            if (res.code == 10000) {
              ...
              this.getList();
              localStorage.setItem("show6",localStorage.getItem("checkedValue6"));
            } else {
              this.$message({
                type: "warning",
                message: this.$t("DeviceMan.hint12")

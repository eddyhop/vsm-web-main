      ...
      <div class="event">
        ...
        >
          ...
          <el-form-item :label="$t('vsr1000.describe')" prop="descr" label-width="120px">
            <el-input v-model="ruleForm.descr" placeholder disabled></el-input>
          </el-form-item>
          <el-form-item :label="$t('vsr100.static.port2')">
            <el-select filterable v-model="ruleForm.port" :placeholder="$t('vsr1000.choose')" disabled>
              <el-option
          ...
          <!-- <el-form-item :label="$t('vsr100.acl.direction')" style="margin-left:50px">
            <el-select filterable v-model="ruleForm.direction" :placeholder="$t('vsr1000.choose')" disabled>
          ...
          <div class="tabsCon">
            <el-tabs v-model="editableTabsValue" type="card" closable class="tabsListD1">
              <el-tab-pane
              ...
              >
                ...
                >
                  <el-input v-model="item.content.sourceIp" placeholder disabled></el-input>
                </el-form-item>
                <el-form-item
                  :label="$t('vsr1000.maskLength')"
                  :prop="`editableTabs[${index}].content.sourceMask`"
                >
                  <el-input v-model.number="item.content.sourceMask" placeholder disabled></el-input>
                </el-form-item>
                <el-form-item
                  :label="$t('vsr1000.dest1')"
                  :prop="`editableTabs[${index}].content.aimIp`"
                >
                  <el-input v-model="item.content.aimIp" placeholder disabled></el-input>
                </el-form-item>
                <el-form-item
                  :label="$t('vsr1000.maskLength')"
                  :prop="`editableTabs[${index}].content.aimMask`"
                >
                  <el-input v-model.number="item.content.aimMask" placeholder disabled></el-input>
                </el-form-item>
              </el-tab-pane>
            </el-tabs>
            <!-- <div id="addBtn">
...
export default {
  ...
  methods: {
    ...
    async selectList(row) {
      ...
      this.ruleForm.port = row.portId; //接口ID
                                       // The interface ID
      this.ruleForm.direction = row.direction + ""; //方向ID

  ...
  <div class="mobileSetting">
    <div class="title">
      <h3>
        ...
        <span>{{ $t("Mobile.groupConfig") }}</span>
      </h3>
    ...
    <div class="devList" >
      ...
      <el-table  v-show="tab1Show"  :data="trustData" style="width: 100%"   border stripe  size="small" tooltip-effect="dark" >
      ...
      <el-table  v-show="tab2Show"  :data="trafficLimitersData" style="width: 100%"   border stripe  size="small" tooltip-effect="dark" >
        <el-table-column prop="name"  :label="$t('Mobile.name')" align="center"  show-overflow-tooltip  :resizable="false"  ></el-table-column>
        <el-table-column prop="description"   :label="$t('Mobile.description')" align="center" show-overflow-tooltip :resizable="false" ></el-table-column>
...
export default {
  ...
  methods: {
    addInfo(){
      if(this.tab1Show) {
        this.showTrust = true ;
        this.$refs.addTrustPolicy.dataInit("1",this.queryData.groupId,this.queryData.name,this.queryData.tenantId);
      } else {
        ...
        this.$refs.addTrafficLimiter.type="1";
      }
    },
    retpage(){
      let params = {
    ...
    tabsEvent(el) {
      ...
      if(el.id === 1 ){
        ...
        this.tab1Show = false;
        this.tab2Show = true;
        this.searchTest = this.$t('Traffic.searchText');
      }
      this.forSearchList();
    },
    pageChange(val) {
    ...
    editTrust(row) {
      ...
      this.$refs.editTrustPolicy.dataInit(row,this.queryData.name);
    },
    editLimiter(row) {
      this.showEditTrafficLimiter = true;
      this.$refs.editTrafficLimiter.clientId=this.queryData.groupId;
      this.$refs.editTrafficLimiter.type="1";
      ...
      this.$refs.editTrafficLimiter.dataInitForEdit(row, "");
    },

   ...
   <div class="cont">
      ...
      <div class="content">
        <div class="search">
            <el-row :gutter="24">
                ...
                <el-col :span="10">
                    <div class="search-item">
                        <el-input
                            suffix-icon="el-icon-search" size="small" v-model="deviceName"
                            >
                        </el-input>
                    </div>
                </el-col>
        ...
        <div class="table-content">
          <el-table :data="tableData" stripe border style="width: 100%"  @current-change="handleSelectionChange">
            <el-table-column
              label="单选"
              width="55">

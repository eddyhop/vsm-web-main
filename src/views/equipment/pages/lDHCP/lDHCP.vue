<template>
  <div class="lDHCP">
    <!-- vsr-lite DHCP -->
    <div class="even">
        <el-form :model="val" :rules="rules" ref="form" label-width="auto" label-position="right" @submit.native.prevent>
          <el-form-item :label="$t('vsr100.dhcp.dhcpServer')" >
              <el-switch v-model="switchState" active-color="#3678C8" inactive-color="#EFEFEF" @change="open"></el-switch>
          </el-form-item>
          <div v-show="flag">
          <el-form-item :label="$t('vsr100.dhcp.startAddress')" prop="sip">
              <el-input v-model="val.sip" :placeholder="$t('vsr100.dhcp.enterContent')" size="small"></el-input>
          </el-form-item>
          <el-form-item :label="$t('vsr100.dhcp.endAddress')" prop="eip">
              <el-input v-model="val.eip" :placeholder="$t('vsr100.dhcp.enterContent')" size="small"></el-input>
          </el-form-item>
          <el-form-item :label="$t('vsr100.dhcp.addressLease')" prop="time">
              <el-input v-model.number="val.time" :placeholder="$t('vsr100.dhcp.enterContent')" size="small"></el-input><span>{{$t('vsr100.dhcp.minute')}}</span>
          </el-form-item>
          <el-form-item :label="$t('vsr100.dhcp.gateway')" prop="code">
              <el-input v-model="val.code" :placeholder="$t('vsr100.dhcp.enterContent')" size="small"></el-input>
          </el-form-item>
          <el-form-item :label="$t('vsr100.dhcp.preferred')" prop="dns">

<template>
  <!-- DNAT修改 -->
  <div class="addDNAT">
    <div :class="lang=='en'? 'contentEn content frameWrap' : 'content frameWrap'">
      <h4 class="title">
        <span>{{$t('newModel.edit')}}DNAT</span>
...
export default {
  ...
  mounted(){
    ...
    var frameWrap = document.querySelector('.frameWrap');
    if(langHint=="en-US"){
      frameWrap.style.width = '600px';
    }else{
      frameWrap.style.width = '500px';
    }
  },
  methods: {
    //取消
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          let params = {
            ...
            id: this.ruleForm.id,
            locpalPort:
              this.ruleForm.locpalPort == null ? "" : this.ruleForm.locpalPort,
            name: this.ruleForm.name,
            outIp: this.ruleForm.outIp,
            outPort: this.ruleForm.outPort == null ? "" : this.ruleForm.outPort,

...
const en = {
    ...
    // login
    Login: {
        platform: "VSN Orchestration Portal",
    ...
    Home: {
        ...
        more:"More",
        refresh:"Refresh",
        totalTraffic:"Total Traffic Sent/Received",
    },
    // 设备管理
    ...
    DeviceMan: {
        ...
        edgeConfigurations:"Edge Configurations",
        licenseManagemert:"License Management",
        settings:"Settings",
        ...
        county: "county",
        location: "Location",
        DistributionOfTheTenant: "Assign to a tenant",
        DeviceSynchronization: "Edge Synchronization",
        assignToATenant:"Assign to a tenant",
        deviceReboot: "Edge Reboot",
        more: "More",
        type: "Type",
        territory: "Territory",
        ...
        base: "Base",
        device: "Edge",
        deviceRange: "Edge Range",
        all: "All",
        unnamed: "Unnamed Edge",
        deviceType: "Edge Type",
        tenant: "Tenant",
        devNameNumber: "Edge Name, Serial Number",
        search: "Search",
        index: "Index",
        devName: "Name",
        devNumber: "Edge Serial Number",
        ...
        isoFileCreate: "Edge Deployment",
        isoFileCreateCard: "Create Edge Deployment",
        platform: "Platform",
        timezone: "Timezone",
        vsnEdgeVMProps: "VSN Edge VM Properties",
        vmEdgeName: "VM Edge Name",
        localImageDirectory: "Local Image Directory",
        targetImageDirectory: "Target Image Directory",
        vsnEdgeNetworking: "VSN Edge Networking",
        nwInterface: "Network Interface 1",
        hostNwName: "Host Network Name",
        ...
        download: "Download",
        nameServerPlaceholder: "Enter comma separated Name server IPs",
        editDev: "Edit VSN Edge",
        save: "Save",
        cancel: "Cancel",
        ...
        hint1: "Edge name edited successfully, tenant cannot be reassigned",
        hint2: "Edge edited successfully, tenant is assigned successfully",
        hint3: "The Edge configuration has been cleared, and if you continue, the Edge name and tenant will be removed.",
        hint4: "After the configuration is cleared, all the configuration of the Edge will be empty and returned to its original state (unassigned tenant). Are you sure to clear the configuration?",
        ...
        hint9: "The configuration of the Edge has been cleared",
        hint10: "Do you confirm to synchronize VSA?",
        hint11: "Synchronize successfully!",
        hint12: "Synchronization failure!",
        hint13: "Cancel",
        hint14: "After the configuration is cleared, all configurations of the Edge will be cleared. Are you sure you want to clear the configuration",
        hint15: "registered successfully",
        hint16: "The Edge has been registered. If you want to modify it, please log out first!",
        hint17: "When registering the cloud Edge, the VPC table of the Edge will be affected, and the cloud Edge network may shake. Please be careful!",
    ...
    App: {
        ...
        hint21: "Edit failure",
        hint22:"Please enter a value between 0-65535",
        noData: "No Data",
        ok: "OK",
        a: "an",
        wifiUset:"Please enter the SSID",
        wifiPaw:"Please enter the Password",
        wifiPawTest:"The password length must be 8-63 characters",
        wifiSSIDValidate:"Please enter Alphanumeric characters and hyphen only",
        appDel:"There are still applications in this application group",
        existsName:"This Name already exists,Please choose a different name.",
        existsPriority:"This priority value already exists, please enter a different value.",
    },
    // 配置文件管理
    // Profile management
    // Profile management
    ...
    Upgrade: {
        ...
        tenant: "Tenant",
        devType: "Edge Type",
        verNameDevName: "Hardware Version, Edge Name",
        index: "Index",
        devName: "Edge Name",
        devNumber: "Edge Serial Number",
        ...
        hint7: "Are you sure to download the following Edge?",
        hint8: "Service will be interrupted during upgrade",
        hint9: "Completed downloads and upgrades cannot be terminated. Edge that have not completed downloads and upgrades will stop downloading and upgrading",
    ...
    Configuration: {
        ...
        NaaSEdgeConfigurationError:"This Site VPN connection is not allowed to be edited or deleted",
        NaaSEdgeVpnStartOrStopError:"This Site VPN connection is not allowed to be started or stopped",
        remind: [
            " this Edge will cause a service interruption, are you sure you want to restart this Edge?",
    ...
    vsr1000: {
        ...
        noMore: "No More",
        saved: "Saved successully",
        newGroup: 'New Favorites',
        devTopic: `Edge Overview`,
        onLine: "Online",
        OffLine: "OffLine",
        connected: "Connected",
        device: " Edge connected",
        ...
        importDestinationIp: "Please enter the Destination IP",
        inACL: "Inbound ACL",
        inQOS: "Inbound QOS",
        outACL: "Outbound ACL",
        outQOS: "Outbound QOS",
        ...
        Minutes: " Minutes ",
        Seconds: " Seconds ",
        ipv4s: "Please enter the IPv4 Address (CIDR)",
        ...
        msg2: "There are 8 charts of 4 Edge in this group. Are you sure to delete them ?",
        ...
        msg7:"Please enter the Gateway",
        msg8:"The Gateway and IPV4 are not in the same network segment",
        msg9:"The LAN bridged logical interface already exists",
        enabled:"Enabled",
        disabled:"Disabled",
        delLogical:"The default WAN interface cannot be deleted",
        sure:"Are you sure?",
        remind2: [
            "Saved successfully",
            "Edit successfully",
            ...
            "Please enter IP Address + netmask in the correct format",
            ...
            "Please enter Destination Network",
            "Please select Advertising Edge",
        ],
        greRule: [
            "Please enter the Name",
            "Please enter IP address",
            "Please enter IPv4 Address in the correct format",
        ...
        remind: [
            ...
            "Please enter",
            "Please enter IPv4 address + mask in the correct format",
            "Please enter correct IPv6 address + mask",
            "Fail Saved",
            "Please enter a value between  64-9000",
            "Please select",
            "请输入正确的MAC地址",
            "请输入正确的IP地址",
        ...
        aclremind: [
            ...
            "Please enter a value between 1-65535",
            "Please enter IPv4 Address in the correct format",
            "The name has been used",
            ...
            "Please enter a value between 1-65535",
            "Please enter the Application Priority",
            "Please enter IPv4 Address in the correct format",
            "Please enter the Name",
            "Please select the DSCP",
    ...
    vsr100: {
        ...
        static: {
            ...
            remind: [
                ...
                "Please enter IP Address in the correct format",
    ...
    newModel: {
        ...
        port: {
            ...
            modifySuccessfully:"Saved successully",
        },
        wifi: {
    ...
    newLang100: {
        ...
        static: {
            title1: 'Check',
            title2: 'Edit',
            title3: 'Please enter a value between 1-65535',
            title4: 'Please enter a value between 0-245',
        }
    },
    Homepage:{
        fixedClients: "Fixed clients",
        mobileClients: "Mobile clients"
    },
    Config: {
        fixedSubs: "Fixed Subscription",
        mobileSubs: "Mobile Subscription",
        clientGateway1: "Client Gateway #1",
        clientGateway2: "Client Gateway #2",
        naasTunnel: "NaaS Tunnel",
        fixedClientAttribute: "Fixed Client Attribute",
        mobileClientAttribute: "Mobile Client Attribute"
    },
    Diag: {
        fixedClientCount: "Fixed Client Count",
        mobileClientCount: "Mobile Client Count",
        restartNaasTunnels: "Restart NaaS Tunnels",
        naasTunnelsStatus: "NaaS Tunnels Status",
        fixedClientStats: "Fixed Client Stats",
        mobileClientStats: "Mobile Client Stats",
        name: "Name",
    ...
    Monit: {
        ...
        opreationalState:"Operational State",
        configuredState:"Configured State",
        macAddress:"MAC Address",
        mtu:"MTU",
        state:"Current state",
        ...
        Hint2: "Does the chart remove this group?Once removed, you will not be able to find the Edge in this group",
        Hint3: "Chart。",
        Hint8: "You are sure to put the link",
        Hint9: "Does the chart remove this group?Once removed, you will not be able to find the Edge chart in this group.",
        ...
        ok: "OK",
        cancel: "Cancel",
        collectionHint: "You do not have any saved Edge, please save the Edge you want to monitor.",
        ...
        hadDev: "The selected Edge",
        hadLink: "The selected link",
        plea1: "Edge name, serial number",
        plea2: "Edge name, link name",
    ...
    UserMan: {
        ...
        hint12: "The password can contain uppercase, lowercase letters, digits and special characters including ~`!@#$%^&*()_-+={[}]|:;<,>.?/",
        ...
        noData: "No Data",
        choose: "Please select",
        hint20:"The password must be 8-16 characters long.",
    },
    // 租户管理
    // Tenant management
    // Tenant management
    TenMan: {
        ...
        cancel1: "Cancel",
        hint1: "The Tenant still has Edge. Cannot be deleted",
    ...
    TenServiceSet: {
        ...
        hint2: "Please select the Edge you want to add",
        hint3: "Saved successully",
    ...
    Vpn: {
        ...
        hint8: "Please enter a value between 1-32",
        hint9: "<= mask maximum",
        ipMask: "IP + mask",
        import: "Please enter",
    ...
    Mobile: {
        ...
        tenantRoutingDomain: "Tenant routing domain",
        pass: "Password",
        importUserName: "Please enter the Username",
        importPass: "Please enter the Password",
        ...
        save: "Save",
        importClientGroup: "Please select the Client Group",
        clientConfig: "Client Configurations",
        groupConfig: "Group Configurations",
        connections: "Connections",
        trustPolicies: "Trust Policies",
        connectionName: "Connection Name",
        connectionIp: "Connection IP Address",
        IPAddress: "IP Address",
        ...
        destMatch:"Destination Match",
        destName:"Destination Name",
        appMatch:"Application Match",
        appName:"Application Name",
        reflexive:"Reflexive",
        enterPreference: "Please enter the Preference",
        enterIP: "Please select the IP Address",
        enterName: "Please enter the Name",
        editConnection: "Edit Mobile Client Connection",
        addTrustPolicy: "Add Trust Policy",
        editTrustPolicy: "Edit Trust Policy",
        enterAction:"Please select the Action",
        enterPriority:"Please enter the Priority",
        enterSourceMatch:"Please select the Source Match",
        enterSourceName:"Please select the Source Name",
        enterDestMatch:"Please select the Destination Match",
        enterDestName:"Please select the Destination Name",
        enterAppMatch:"Please select the Application Match",
        enterAppName:"Please select the Application Name",
        enterReflexive:"Please enter the Reflexive",
        enterTrafficProfile:"Please select the Traffic Profile",
        checkDelGroup:"There are still clients in this client group",
        alreadySubnetAddress:"This subnet address already exists, please use a different subnet address",
        areYouSure:"Are you sure？",
        subnetRange:"There are Client IPs not in this subnet range",
        enterSubnetAddress: "Please enter the Subnet Address",
        enterAdvertisedSubnets: "Please enter the Advertised Subnets",
        ipAddressOutOfClientGroup: "IP address is outside of Client-Group range",
        ipAddressInUse: "This IP address is in use.",
    },
    Traffic: {
        trafficManagementTitle: "Traffic Management",
        trafficProfiles: "Traffic Profiles",
        trafficProfile: "Traffic Profile",
        addTrafficProfile: "Add Traffic Profile",
        editTrafficProfile: "Edit Traffic Profile",
        uploadUnlimited: "Upload Unlimited",
        uploadRate: "Upload Rate (Mbps)",
        downloadUnlimited: "Download Unlimited",
        downloadRate: "Download Rate (Mbps)",
        bandwidth: "Bandwidth",
        searchText: "Profile Name",
        trafficLimiters: "Traffic Limiters",
        ...
        addTrafficLimiter: "Add Traffic Limiter",
        editTrafficLimiter: "Edit Traffic Limiter",
        destinationMatch: "Destination Match",
        destinationName: "Destination Name",
        connectionConfiguration: "Connection Configurations",
        unlimited: "Unlimited"
    },
    // 时间设置
    // Set the time
    ...
    cloudDev: {
        ...
        deviceConfig: 'Edge Configuration',
        del: 'Delete',
        add: 'Add',
        tenant: 'Tenant',
        online: 'online',
        ...
        cloudDevice: 'Name of cloud Edge',
        key: 'Key pair',
    ...
    netWork:{
        ...
        msg3:"There is a network configuration item under this Edge. Please clear the network first and then configure and clear it",
        msg4:"There is no EDGE node, please add a new one first before submitting.",
        msg5:"There is no As Number for the current Edge, please go to base-Edge Management to add",
        msg6:"There is a network configuration item under the Edge, please clear the networking first, then log out",
        ...
        msg11:"Please close the acceleration gateway of the current Edge before closing the private network connection"
    ...
    subscription:{
        ...
        add:"Add Traffic Profile",
        dhcpServerTitle:"DHCP Pools",
        ...
        dhcpServer:{
            ...
            leaseTime:"Lease Time (mins)",
            primaryDNS:"Primary DNS",
            operations:"Operations",
            addDHCPServer:"Add DHCP Pools",
            ...
            optionVal:"Value",
            optionValEnter:"Please enter a value",
            testValEnter:"Please enter a valid input",
            remind:[
                'Please enter the Name',
                ...
                'Address pool is conflict with a logical interface IPv4 Address.',
        ...
        vpns:{
            ...
            name:"Name",
            description:"Description",
            tunnelEnacaplation:"Tunnel Encapsulation",
            remotePeer:"Remote Peer",
            vpnRole:"Role",
            logicalInterface:"Logical Interface",
            ...
            operations:"Operations",
            addSiteVPN:"Add Fixed Client Attribute",
            editSiteVPN:"Edit Fixed Client Attribute",
            type:"Type",
            vpnEndpointIPAddress:"Endpoint IP Address",
            mobileClientPool:"Mobile Client Pool",
            addClientVPN:"Add Mobile Client Attribute",
            editClientVPN:"Add Mobile Client Attribute",
            secureVPN:"Secure Gateway",
            remind:[
                'Please enter the Name',
                ...
                'Please enter the Inner IP Address',
        ...
        firewall:{
            ...
            remind:[
                ...
                'This priority value already exists, please enter a different value.',
            ]
        },
        trafficManagement:{
            ...
            remind:[
                ...
                'Please select the Logical Interface',
                'Please enter a value between 1-65535',
                'Please enter the CIR(Kbps)',
                'Please enter the CBS(Bytes)',
                'Please enter the PIR(Kbps)',
                'Please enter the PBS(Bytes)',
                'Please select the Conform Action',
                'Please select the Exceed Action',
                'Please select the Violate Action',
            ]
        }
    },
    vsnOperaions:{
        vsnOperaions:"VSN Operations",

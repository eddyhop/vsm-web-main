    ...
    <div class="vsrPanCon">
      <dl class="hint">
        ...
        <dd>
          ...
          <p class="devTime">
            <span>{{$t('vsr1000.onLineTime')}}：{{getTime(startTime)}}</span>
            <span>{{$t('vsr1000.sustainOnLine')}}：{{secondsFormat(keepTime)}}</span>
          </p>
        </dd>
      </dl>
      <ul class="showList">
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <li class="slItem">
              <h5>{{$t('vsr1000.MemoryOccupancy')}}</h5>
          ...
          <el-col :span="6">
            <li class="slItem">
              <h5>{{$t('vsr1000.lessNum')}}</h5>
              <div class="showNum">{{tunnelAll}}</div>
              <p class="linkNum">{{tunnelActive}}{{$t('vsr1000.device')}}</p>
            </li>
          </el-col>
          <el-col :span="6">

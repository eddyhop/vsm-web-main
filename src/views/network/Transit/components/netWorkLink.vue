      ...
      <div class="formList">
        ...
        >
          ...
          <el-form-item :label="$t('netWork.InternetAddress')" prop="serAddr">
            <el-input v-model="ruleForm.serAddr" disabled></el-input>
          </el-form-item>
          <h4 :class="lang=='en' ? 'devTitle devTitleEn' : 'devTitle'">
          ...
          <el-form-item :label="$t('netWork.InternetAddress')" prop="cliAddr">
            <el-input v-model="ruleForm.cliAddr" disabled></el-input>
          </el-form-item>
          <div class="submit">
...
<script>
import { sceneNodeGetVpnDetails, sceneNodeVpnAdd } from "@/services";
export default {
  data() {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          if (this.ruleForm.vpnEnable) {
            ...
            if (this.rowData.accelerationEnable) {
              this.$message({
                type: "warning",
                message: this.$t('netWork.msg11'),
              });
            }else{
              sceneNodeVpnAdd(params).then((res) => {
                if (res.code === 10000) {

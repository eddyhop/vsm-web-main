<template>
  <div class="addVPN">
    <div :class="`context ${lang=='en'?'contextEn':''}`">
      <h4 class="title">
        <span>{{$t('vsr1000.add')}} {{$t('vsr1000.networkLink')}}</span>
      ...
      <div class="event">
        ...
        >
          ...
          <el-form-item :label="$t('vsr1000.logicPort')" prop="region1">
            <!-- <el-select filterable v-model="ruleForm.region1" :placeholder="$t('vsr1000.choose')">
              <el-option label="123" value="123123123"></el-option>
              <el-option
                v-for="item in ruleForm.region1Arr"
                :key="item.id"
                :label="item.portName"
                :value="item.id"
              ></el-option>
          ...
          <!-- <el-form-item :label="$t('vsr1000.bandwidth')" prop="broad">
            <el-input v-model.number="ruleForm.broad" placeholder="kbps"></el-input>
          </el-form-item> -->
          <el-form-item
          ...
          >
            <el-select filterable
              ...
              placeholder="Client"
              @change="roleChange(ruleForm.region2)"
            >
              <el-option
          ...
          <el-form-item
            ...
            :prop="rolePart==='Client' ? 'Ip' : 'change'"
            :label-width="`${lang=='en'?'190px':'110px'}`"
          >
            <el-input v-model="ruleForm.Ip" v-if="rolePart==='Client'"></el-input>
            <el-select filterable
              v-else-if="rolePart !=='Client'"
              v-model="ruleForm.change"
  ...
  methods: {
    ...
    submitForm(formName) {
      ...
      let data = {
        ...
        logicalId: this.ruleForm.region1,
        deviceId,
        tenantId,

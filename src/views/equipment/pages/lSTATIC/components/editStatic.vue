<template>
  <div class="editStatic">
    <div class="context">
      <div class="title">
        STATIC{{isEdit ? $t('vsr100.static.edit') : $t('newLang100.static.title1')}}
      ...
      <div class="item" :style="lang=='en'?'':'marginLeft:70px'">
        <el-form :model="form" :rules="rules" ref="form" label-width="auto" :inline="true" :disabled="!isEdit" class="demo-ruleForm" @submit.native.prevent>
          ...
          <el-form-item :label="$t('vsr100.static.description')" prop="des">
            <div class="item-ipt">
              <el-input
          ...
          <el-form-item :label="$t('vsr100.static.destinationIPAddress')" prop="ip">
            <div class="item-ipt">
              <el-input v-model="form.ip" @blur="zhuan" :placeholder="$t('vsr100.static.destinationIPAddress')" size="small"></el-input>
            </div>
          </el-form-item>
          ...
          <el-form-item :label="$t('vsr100.static.distance')" prop="dis">
            <div class="item-ipt">
              <el-input v-model="form.dis" size="small"></el-input>
            </div>
          </el-form-item>
          <!-- <el-form-item :label="$t('vsr100.static.tag')" prop="title">
            <div class="item-ipt">
              <el-input v-model.number="form.title" size="small"></el-input>
            </div>
          </el-form-item>
...
<script>
import { setLStatic, findByRepeatIp} from "@/services";
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        ip: [
          { required: true, message: this.$t('vsr100.static.remind[5]'), trigger: "blur" },
          {
        ...
        api:[ { required: true, message: this.$t('vsr100.static.choose'), trigger: "change" }]
      }
    };
  },
  methods: {

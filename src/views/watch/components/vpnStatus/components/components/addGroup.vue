...
export default {
  ...
  methods: {
    //隐藏弹框 Hidden bounced
    // Hidden Pop-up Hidden Mysteries
    close() {
      this.$parent.isShow = false;
    },
    //分组点击输入框获焦 Group click the input box to get focus
    ...
    //失去焦点隐藏输入框 Lose focus to hide input box

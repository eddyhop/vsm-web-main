  ...
  <div class="logical">
    ...
    <div class="tableView">
      <el-table
        ...
        size="small"
      >
        <el-table-column prop="ipAddress" :label="$t('Monit.ipAddress')" show-overflow-tooltip :resizable="false"></el-table-column>
        <el-table-column prop="bfdInterface" :label="$t('Monit.interface')" show-overflow-tooltip :resizable="false"></el-table-column>
        ...
        <el-table-column prop="bfdInterval" :label="$t('Monit.interval')" show-overflow-tooltip :resizable="false"></el-table-column>
        <el-table-column prop="timeout" :label="$t('Monit.timeout')" show-overflow-tooltip :resizable="false"></el-table-column>
      </el-table>
      <div class="page">
        <el-pagination
          :page-sizes="[5, 10]"
...
export default {
  ...
  methods: {
    ...
    physicalPortInit() {
      ...
      getNaaSBfdInfo(params).then( res =>{

    ...
    <div :class="lang=='en' ? 'contentEn content' : 'content'">
      ...
      <div class="formList">
         <el-form
           ...
           :rules="rules"
           ref="form"
           :label-width="lang=='en' ? 'auto' : '200px'"
           class="demo-ruleForm"
          ...
          <el-form-item :label="$t('newModel.vsr1100.sourceMAC')" prop="sourceMAC">
            <el-input v-model="ruleForm.sourceMAC"></el-input>
          </el-form-item>
          <el-form-item :label="$t('newModel.vsr1100.sevenFilter')" prop="sevenFilter">
            <el-input type="textarea" :placeholder="$t('newModel.url.msg1')" v-model="ruleForm.sevenFilter"></el-input>
          </el-form-item>
          ...
          <el-form-item :label="$t('Alarm.eventThresholdValue')" prop="threshold" >
...
<script>
import { getDict,sevenFirewalldAdd } from "@/services";
export default {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          let params = {
            ...
            sourceMAC: this.ruleForm.sourceMAC,
            sevenFilter: this.ruleForm.sevenFilter,
            threshold: this.ruleForm.threshold,
          };
          sevenFirewalldAdd(params).then(res => {
            if (res.code === 10000) {
              this.$message({
                type: "success",

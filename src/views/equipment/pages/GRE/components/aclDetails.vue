...
export default {
        ...
        editableTabs: [
          {
            ...
            content: {
              ...
              action: "",
              //目的地ip destination IP address.
              // Destination IP Destination IP Address.
              aimIp: "",
              //目的地掩码 Destination mask
              // Destination mask Destination mask
              aimMask: "",
              //选择的应用 Application of choice
  ...
  methods: {
    ...
    async selectList(val) {
      ...
      this.ruleForm.port = aclDetail.result.portId//接口ID interf ace ID
                                                  // Interface ID Interf ACE ID
      this.ruleForm.direction = aclDetail.result.direction+''//方向ID direction ID

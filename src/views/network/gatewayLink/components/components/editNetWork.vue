<template>
  ...
  <div class="addDNS">
    <div class="content">
      <h4 class="title">
        <span>{{$t('newLang100.static.title2')}} {{$t('newModel.networkSegment')}}</span>
      ...
      <div class="formList">
        ...
        >
          ...
          <el-form-item label="Router Map" class="RouteMap" prop="domain">
            <el-select filterable v-model="bgpPolicyId">
...
export default {
  data() {
    return {
      ...
      ruleForm: { cidr: "", bgpPolicyId: "", id: "", sendId: "" },
      devType: "",
      bgpPolicyId: "",
      routeMapList: [],
      rules: {
  ...
  methods: {
    ...
    dataInit(row) {
      this.ruleForm.cidr = row.cidr;
      this.ruleForm.bgpPolicyId = row.bgpPolicyId;
      this.ruleForm.id = row.id;
      this.ruleForm.sendId = row.sendId;

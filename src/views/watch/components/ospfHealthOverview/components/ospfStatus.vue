  ...
  <div class="logical">
    ...
    <div class="tableView">
      <el-table
        ...
        size="small"
      >
        <el-table-column prop="neighbours" :label="$t('Monit.ospfNeighbor')" show-overflow-tooltip :resizable="false"></el-table-column>
        <el-table-column prop="routerId" :label="$t('Monit.routerID')" show-overflow-tooltip :resizable="false"></el-table-column>
        <el-table-column prop="routerIp" :label="$t('Monit.routerIP')" show-overflow-tooltip :resizable="false"></el-table-column>
         <el-table-column prop="ospfInterface" :label="$t('Monit.interface')" show-overflow-tooltip :resizable="false"></el-table-column>
        <el-table-column prop="state" :label="$t('Monit.state')" show-overflow-tooltip :resizable="false"></el-table-column>
        <el-table-column prop="since" :label="$t('Monit.since')" show-overflow-tooltip :resizable="false"></el-table-column>
      </el-table>
      <div class="page">
        <el-pagination
          :page-sizes="[5, 10]"
...
<script>
import {
  getPhysicalPort, getPortList, getLogicalPortByTts, getNaaSOspfInfo,
} from "@/services/index";
export default {
  props: {},
  components: {
  ...
  methods: {
    ...
    physicalPortInit() {
      ...
      console.log(params);
      getNaaSOspfInfo(params).then( res =>{

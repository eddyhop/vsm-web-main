<template>
  <div class="addzh">
    <div class="cont">
      <div class="title">
        {{$t('TenDomain.add')}} {{$t('TenDomain.tenDomain')}}
      ...
      <div class="even">
        <el-form :model="form" :rules="rules" ref="form" label-width="120px">
          ...
          <!-- <el-form-item :label="$t('TenDomain.tenant')" prop="rent">
            <div class="a">
              <el-select filterable
                size="small"
                v-model="form.rent"
                :placeholder="$t('TenDomain.choose')"
          ...
          <!-- <el-form-item :label="$t('TenDomain.maxiMum')">
            <el-input v-model.number="form.max" size="small"></el-input>
          </el-form-item> -->
          <el-form-item :label="$t('TenDomain.description')">
            <el-input v-model="form.describe" maxlength="50" size="small"></el-input>
          </el-form-item>
          <el-form-item>
            <div class="contr">
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    rentRFSet(params).then(res=>{
                        if(res.code==10000){
                            this.$message({
                               message: this.$t('TenDomain.hint2'),
                                type: 'success'
                            })
                            this.$parent.getList()
                        }else{
                            this.$message({
                                message: this.$t('TenDomain.hint10'),
                                type: 'warning'
                            });
                        }
                    })

  ...
  <div class="wifi">
    <div class="form">
      ...
      >
        ...
        <el-form-item
          :label="$t('newModel.wifi.CountryCode')"
          prop="countrycode"
        >
      ...
      wifiGetWifiInfo(params).then((res) => {
        if (res.code === 10000) {
          if(res.result.name == null){
            ...
            this.ruleForm.countrycode = res.result.countrycode;
            this.ruleForm.wifiBand = res.result.wifiBand;
          }
        }
      });

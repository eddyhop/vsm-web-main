  ...
  <div class="mask">
    <div class="first" v-show="show">
      <div class="msg">
        ...
        <span>{{$t('Configuration.remind[1]')}} {{showMsg}} {{$t('Configuration.remind[2]')}}！</span>
      </div>
      <div class="submit">
        <button class="cancel" @click.prevent="close">{{$t('DeviceMan.cancel')}}</button>
        <button class="save" @click.prevent="save">{{$t('DeviceMan.save')}}</button>
      </div>
    </div>
    <div class="last" v-show="!show">
      ...
      <div class="twiceMsg">{{showMsg}}{{$t('Configuration.remind[0]')}}{{showMsg}}么？</div>
      <div class="twiceSubmit">
        <button class="twiceSave" @click.prevent="show = true">{{$t('DeviceMan.save')}}</button>
        <button class="twiceCancel" @click.prevent="$parent.isShow = false">{{$t('DeviceMan.cancel')}}</button>
      </div>
    </div>
  </div>
</template>

<template>
  <div class="chartsMain">
    <div class="time">
      <ul class="vsrTabsNav">
        <li @click="choseToday" class="tabsItem" :class="{active:tabIndex===1}">{{$t('vsr1000.today')}}</li>
        <li @click="choseWeek" class="tabsItem" :class="{active:tabIndex===2}">{{$t('vsr1000.week')}}</li>
        <li @click="choseMounth" class="tabsItem" :class="{active:tabIndex===3}">{{$t('vsr1000.month')}}</li>
      </ul>
      <!-- <ul class="vsrTabsNav">
            <li

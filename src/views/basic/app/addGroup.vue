<template>
  <div class="addSTATIC">
    <div :class="`context ${lang=='en'?'contextEn':''}`">
      <h4 class="title">
        <span>{{$t('App.addApplicationGroup')}} </span>
      ...
      <div class="event">
        ...
        >
          ...
          <el-form-item :label="$t('vsr1000.name')" prop="groupName">
            <el-input v-model="appForm.groupName"  :placeholder="$t('vsr1000.name')" ></el-input>
          </el-form-item>

          <el-form-item :label="$t('vsr1000.describe')" prop="groupDesc">
            <el-input v-model="appForm.groupDesc" :placeholder="$t('vsr1000.describe')"></el-input>
          </el-form-item>
